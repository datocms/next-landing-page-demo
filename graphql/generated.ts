...
/** Block of type All Documentation Section (all_documentation_section) */
export type AllDocumentationSectionRecord = RecordInterface & {
  __typename?: 'AllDocumentationSectionRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
...
/** Block of type All Documentation Section (all_documentation_section) */
export type AllDocumentationSectionRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type PageModelSectionsField = AboutIntroRecord | AllDocumentationSectionRecord | AllPostsSectionRecord | BrandSectionRecord | DetailSectionRecord | FaqSectionRecord | FeatureListSectionRecord | FeaturedPostsSectionRecord | HeroSectionRecord | PricingSectionRecord | ReviewSectionRecord | StatsSectionRecord | TeamSectionRecord | VideoSectionRecord;
