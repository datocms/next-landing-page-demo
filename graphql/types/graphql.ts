...
export type PageQuery = { __typename?: 'Query', page?: { __typename: 'PageRecord', id: string, label: string, seo: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, sections: Array<{ __typename: 'AboutIntroRecord', id: string, preHeader?: string | null, header: string, subheader?: string | null, introductionText?: { __typename?: 'AboutIntroModelIntroductionTextField', value: unknown } | null, images: Array<{ __typename?: 'ImageFileField', id: string, responsiveImage: (
          { __typename?: 'ResponsiveImage' }
          & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
        ) }> } | { __typename: 'AllPostsSectionRecord', id: string } | { __typename: 'BrandSectionRecord', id: string, displayOptions: string, brand: Array<{ __typename: 'BrandRecord', brandName: string, brandUrl?: string | null, id: string, brandLogo: { __typename?: 'FileField', url: string } }> } | { __typename: 'ChangelogSectionRecord', id: string, subtitle?: string | null, title: string, featuredVersions: Array<{ __typename: 'ChangeLogRecord', timeOfRelease: string, versionName: string, slug: string, id: string }> } | { __typename: 'DetailSectionRecord', id: string, imagePosition: boolean, details: { __typename?: 'DetailSectionModelDetailsField', value: unknown }, image: { __typename?: 'FileField', responsiveImage?: (
          { __typename?: 'ResponsiveImage' }
          & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
        ) | null } } | { __typename: 'FaqSectionRecord', displayOptions: string, id: string, title: string, subtitle?: string | null, questions: Array<{ __typename?: 'QuestionRecord', question: string, id: string, answer: { __typename?: 'QuestionModelAnswerField', value: unknown } }> } | { __typename: 'FeatureListSectionRecord', id: string, featuresHeader: string, featuresSubheader?: string | null, displayOption: string, feature: Array<{ __typename: 'FeatureRecord', id: string, featureTitle: string, featureDescription: string, featureIcon: { __typename?: 'ImageFileField', responsiveImage: (
            { __typename?: 'ResponsiveImage' }
            & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
          ) } }> } | { __typename: 'FeaturedPostsSectionRecord', id: string, featuredPostsHeader: string, featuredPostsSubheader?: string | null, displayOptions: string, featuredPosts: Array<(
        { __typename?: 'PostRecord', id: string }
        & { ' $fragmentRefs'?: { 'SingleBlogFragment': SingleBlogFragment } }
      )> } | { __typename: 'HeroSectionRecord', id: string, heroSubtitle?: string | null, heroTitle: string, displayOptions: string, buttons: Array<{ __typename?: 'ButtonRecord', id: string, label: string, primary: boolean, url?: string | null }>, heroImage?: { __typename?: 'FileField', responsiveImage?: (
          { __typename?: 'ResponsiveImage' }
          & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
        ) | null } | null } | { __typename: 'PricingSectionRecord', id: string, pricingSectionHeader: string, pricingSectionSubheader?: string | null, displayOption: string, plans: Array<{ __typename?: 'PricingTierRecord', id: string, yearlyPrice: number, monthlyPrice: number, tierName: string, slug: string, planFeatures: string, tierDescription: { __typename?: 'PricingTierModelTierDescriptionField', value: unknown } }> } | { __typename: 'RedirectSectionRecord', id: string, slugToRedirectTo: string } | { __typename: 'ReviewSectionRecord', id: string, reviewSectionHeader: string, reviewSectionSubheader?: string | null, displayOptions: string, reviews: Array<{ __typename?: 'TestimonialRecord', id: string, rating: number, reviewerName: string, reviewerTitle?: string | null, review: { __typename?: 'TestimonialModelReviewField', value: unknown }, reviewerPicture: { __typename?: 'ImageFileField', responsiveImage: (
            { __typename?: 'ResponsiveImage' }
            & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
          ) } }> } | { __typename: 'StatsSectionRecord', id: string, title: string, subtitle?: string | null, statistic: Array<{ __typename?: 'StatisticRecord', id: string, label: string, quantity: number, icon: { __typename?: 'FileField', url: string } }> } | { __typename: 'TeamSectionRecord', id: string, displayOptions: string, title: string, subtitle?: string | null, showcasedMembers: Array<{ __typename?: 'AuthorRecord', name: string, id: string, slug: string, bio: string, description: string, picture: { __typename?: 'ImageFileField', responsiveImage: (
            { __typename?: 'ResponsiveImage' }
            & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
          ) } }> } | { __typename: 'VideoSectionRecord', id: string, videoHeader: string, videoSubheader?: string | null, video: { __typename?: 'VideoField', providerUid: string, provider: string, thumbnailUrl: string }, videoThumbnail: { __typename?: 'ImageFileField', responsiveImage: (
          { __typename?: 'ResponsiveImage' }
          & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
        ) } }> } | null, allPosts: Array<(
    { __typename?: 'PostRecord', id: string }
...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'PostRecord', _publishedAt?: string | null, title: string, seo: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, author: { __typename?: 'AuthorRecord', name: string, bio: string, slug: string, picture: { __typename?: 'ImageFileField', responsiveImage: (
          ...
          & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
              ...
              { __typename?: 'ResponsiveImage' }
              & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
            ) } } }>, blocks: Array<{ __typename: 'AppCtaRecord', id: string, text?: string | null, title: string, googlePlayUrl?: string | null, appstoreUrl?: string | null } | { __typename: 'CtaButtonWithImageRecord', id: string, title: string, subtitle: string, buttonLabel: string, image: { __typename?: 'ImageFileField', id: string, responsiveImage: (
            { __typename?: 'ResponsiveImage' }
            & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
          ) } } | { __typename: 'ImageBlockRecord', id: string, image: { __typename?: 'ImageFileField', id: string, responsiveImage: (
            { __typename?: 'ResponsiveImage' }
            & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
          ) } } | { __typename: 'NewsletterSubscriptionRecord', id: string, buttonLabel: string, subtitle: string, title: string }> } } | null };
...
export type DocumentationHomePageQuery = { __typename?: 'Query', documentationHome?: { __typename: 'DocumentationHomeRecord', title: string, subheader?: string | null, id: string, seo: Array<{ __typename?: 'Tag', attributes?: Record<string, string> | null, content?: string | null, tag: string }>, featuredPages: Array<{ __typename: 'DocumentationPageRecord', id: string, title: string, subtitle?: string | null, slug: string }> } | null };
...
export type SingleBlogFragment = { __typename?: 'PostRecord', _publishedAt?: string | null, slug: string, id: string, title: string, tags: Array<{ __typename?: 'TagRecord', tag: string }>, seoTags?: { __typename?: 'SeoField', description?: string | null, image?: { __typename?: 'FileField', responsiveImage?: (
        { __typename?: 'ResponsiveImage' }
        & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
        ...
        { __typename?: 'ResponsiveImage' }
        & { ' $fragmentRefs'?: { 'DatoImage_ResponsiveImageFragment': DatoImage_ResponsiveImageFragment } }
      ) } } } & { ' $fragmentName'?: 'SingleBlogFragment' };
