...
const FeatureListSelector = ({ fragment }: Props) => {
  const {
    ...
    <div className="mt-16 bg-white py-16 dark:bg-gray-900">
      <div className="container mx-auto px-6 py-8">
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                className={`flex cursor-pointer items-center justify-between rounded-xl border px-8 py-4${
        ...
        <div className="mt-8 flex justify-center">
          <button
            type="button"
            className="transform rounded-md bg-blue-600 px-8 py-2 capitalize tracking-wide text-white transition-colors duration-300 hover:bg-blue-500 focus:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
          >
            Choose Plan
          </button>
        </div>
