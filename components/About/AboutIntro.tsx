...
const AboutIntro = ({ header, subheader, images, introduction, preHeader }) => {
  let [firstWord, ...restOfTheString] = header.split(/\s+/);
  restOfTheString = restOfTheString.join(' ');
  return (
