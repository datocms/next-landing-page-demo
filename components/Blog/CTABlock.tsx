    ...
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-2xl">
        <div className="flex flex-col overflow-hidden rounded-lg bg-gray-50 sm:flex-row md:h-80 lg:ml-0 lg:w-full">
          <div className="order-first overflow-hidden bg-gray-300 sm:order-none sm:h-auto sm:w-1/2 md:h-80 lg:w-2/5">
          ...
          <div className="flex w-full flex-col p-4 text-center sm:w-1/2 sm:p-8 lg:w-3/5">
            ...
            <div className="mt-auto">
              <div
                className={`rounded-lg bg-primary px-8 py-3 text-center text-sm font-semibold text-white md:text-base`}
              >
                {buttonLabel}
              </div>
            </div>
